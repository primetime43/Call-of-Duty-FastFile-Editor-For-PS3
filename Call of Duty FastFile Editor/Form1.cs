using Call_of_Duty_FastFile_Viewer.IO;
using Call_of_Duty_FastFile_Viewer.UI;
    ...
    public partial class Form1 : Form
    {
        ...
        private void filesTreeView_AfterSelect(object sender, TreeViewEventArgs e)
        {
            if (e.Node.Tag is int position)
            {
                ...
                string fileContent = FastFileProcessing.ReadFileContentAfterName(zoneFilePath, position);
